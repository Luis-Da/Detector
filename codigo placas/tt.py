...
def validar_elementos_lista(lista):
    ...
    for texto in lista:
        if len(texto) == 7 and texto[0] in "ABCDEFGHIJKLMNOPQRSTUVWXYZ" and texto[1] in "ABCDEFGHIJKLMNOPQRSTUVWXYZ" and \
                texto[2] in "ABCDEFGHIJKLMNOPQRSTUVWXYZ" and texto[3] == " " and all(
                c != " " for c in texto[0:3] + texto[4:7]):
...
frame_num = 1 
    ...
    # Ruta de salida de la foto
output_path = "registro fotografico/foto_capturada.jpg"
    ...
    for contorno in contornos:
        ...
        if area > 500 and area < 50000:
            ...
            if alp >= 35 and anp >= 85:
                ...
                tomar_foto(video_path, frame_num, output_path)
                # ruta tesseract
