...
# Definir dimensiones deseadas para la ventana de visualización
ancho_deseado = 1280
alto_deseado = 720
...
while True :
    ...
    # Ajustar dimensiones de la ventana de visualización
    cv2.namedWindow('vehiculos', cv2.WINDOW_NORMAL)
    cv2.resizeWindow('vehiculos', ancho_deseado, alto_deseado)
